...
test("can search Google twice", async () => {
  ...
  //Locate the search bar and search for 'salvador, brazil' 
  await driver.findElement(By.name('q')).sendKeys('Salvador, Brazil', Key.RETURN);
  await driver.wait(until.titleIs("Salvador, Brazil - Google Search"), 5000)
  ...
  await driver.findElement(By.name('q')).sendKeys('Thailand', Key.RETURN);
  // TODO Wait for the results page to load
  await driver.wait(until.titleIs("Thailand - Google Search"), 5000)
});
