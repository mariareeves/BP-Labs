...
// console.log(`The total of all the populations: ${totalPopulation}`)
...
// CODE HERE
const myStrongest = monstersInYourPocket.filter((moster) => moster.CP > 200)
...
// CODE HERE
const orderTotals = orders.map((ele) => {
  const total = ele.price * ele.tax
  return total
})
