...
-- select all employee first and last names only that live in calgary 
-- SELECT first_name,last_name from employee where city = 'Calgary';

--select the birthdate for the youngest employee
-- SELECT birth_date from employee order by birth_date desc

--select the birthdate for the oldest employee
-- SELECT birth_date from employee order by birth_date

--select all employees that reports to Nancy Edwards 
...
-- count how many people live in Lethbrigde
